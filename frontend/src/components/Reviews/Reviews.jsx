    ...
    <>
      {reviewsArr.length > 0 ? (
        <>
          ...
          {/* Allow anyone to post reviews, including the owner */}
          <div>
            <OpenModal buttonText="Post Your Entry!" modalComponent={<CreateReviewModal id={spot.id} />} />
          </div>
        </>
      ) : (
        <>
          ...
          {user ? (
            <div>
              <OpenModal buttonText="Post Your Entry!" modalComponent={<CreateReviewModal id={spot.id} />} />
              <h5>Be the first to post your Entry for everyone see your experience!</h5>
            </div>
          ) : null}
        </>
      )}
